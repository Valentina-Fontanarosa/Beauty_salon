package com.beautysalon.demo.authentication;
...
import static com.beautysalon.demo.model.Credentials.ADMIN_ROLE;
import static com.beautysalon.demo.model.Credentials.GENERIC_USER_ROLE;
...
public class AuthConfiguration {
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity)
        ...
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET,"/rest/**","/","/login","/register","/css/**", "/images/**", "favicon.ico", "/professionisti", "/professionista/{id}","/servizi", "/servizio/{id}").permitAll()
